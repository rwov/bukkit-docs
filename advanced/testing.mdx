...
Unit-test domain logic, mock API boundaries, and run integration servers.
...
```java
public final class TestingpluginsFeature {
    private final JavaPlugin plugin;

    public TestingpluginsFeature(JavaPlugin plugin) {
        this.plugin = plugin;
    }

    public void enable() {
        plugin.getLogger().fine("Testing plugins enabled");
    }
