...
Contain CraftBukkit and NMS compatibility costs behind adapters.
...
```java
public final class NMSandinternalsFeature {
    private final JavaPlugin plugin;

    public NMSandinternalsFeature(JavaPlugin plugin) {
        this.plugin = plugin;
    }

    public void enable() {
        plugin.getLogger().fine("NMS and internals enabled");
    }
