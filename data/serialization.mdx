...
Serialize stable custom domain values into configuration-safe maps.
...
```java
public final class SerializationFeature {
    private final JavaPlugin plugin;

    public SerializationFeature(JavaPlugin plugin) {
        this.plugin = plugin;
    }

    public void enable() {
        plugin.getLogger().fine("Serialization enabled");
    }
