...
Design BungeeCord and Velocity transfers, identity, and shared state.
...
```java
public final class ProxynetworksFeature {
    private final JavaPlugin plugin;

    public ProxynetworksFeature(JavaPlugin plugin) {
        this.plugin = plugin;
    }

    public void enable() {
        plugin.getLogger().fine("Proxy networks enabled");
    }
