---
title: "Build homes and warps"
description: "Persist named locations and teleport safely across worlds."
icon: "house"
---

# Build homes and warps

Persist named locations and teleport safely across worlds.
...
```mermaid
flowchart LR
  A["Build homes and warps"] --> B["Build the core"]
