---
title: "Build an arena minigame"
description: "Lobby, countdown, running, ending, and reset states."
icon: "flag-checkered"
---

# Build an arena minigame

Lobby, countdown, running, ending, and reset states.
...
```mermaid
flowchart LR
  A["Build an arena minigame"] --> B["Build the core"]
