---
title: "Build a complete command"
description: "A permission-aware command with parsing and tab completion."
icon: "terminal"
---

# Build a complete command

A permission-aware command with parsing and tab completion.
