...
description: "Dynamic scoreboards without flicker or full rebuilds."
icon: "rectangle-list"
---

# Build a sidebar

Dynamic scoreboards without flicker or full rebuilds.
...
```mermaid
flowchart LR
  A["Build a sidebar"] --> B["Build the core"]
