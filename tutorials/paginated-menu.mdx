---
title: "Paginate a menu"
description: "Display arbitrary data across inventory pages."
icon: "table-list"
---

# Paginate a menu

Display arbitrary data across inventory pages.

{/* visual-map:start */}
<Frame caption="A paginated menu with previous and next controls.">
  ![Paginate a menu example](/assets/modern/inventory-menu.webp)
</Frame>
