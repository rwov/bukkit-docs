---
title: "Build a kit system"
description: "Config-defined kits, previews, claims, and permissions."
icon: "box-open"
---

# Build a kit system

Config-defined kits, previews, claims, and permissions.
...
```mermaid
flowchart LR
  A["Build a kit system"] --> B["Build the core"]
