---
title: "Build safe config reload"
description: "Validate immutable settings before atomic replacement."
icon: "rotate"
---

# Build safe config reload

Validate immutable settings before atomic replacement.
