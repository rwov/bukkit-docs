---
title: "Connect a proxy network"
description: "Transfer players and coordinate shared state."
icon: "network-wired"
---

# Connect a proxy network

Transfer players and coordinate shared state.
