---
title: "Build a boss-bar timer"
description: "Shared countdown phases and lifecycle cleanup."
icon: "bars-progress"
---

# Build a boss-bar timer

Shared countdown phases and lifecycle cleanup.
...
```mermaid
flowchart LR
  A["Build a boss-bar timer"] --> B["Build the core"]
