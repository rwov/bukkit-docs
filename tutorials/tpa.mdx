---
title: "Build teleport requests"
description: "Expiring accept, deny, cancel, and disconnect-safe requests."
icon: "people-arrows"
---

# Build teleport requests

Expiring accept, deny, cancel, and disconnect-safe requests.
...
```mermaid
flowchart LR
  A["Build teleport requests"] --> B["Build the core"]
