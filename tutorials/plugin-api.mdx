---
title: "Expose a plugin API"
description: "Publish services, interfaces, events, and compatibility contracts."
icon: "plug"
---

# Expose a plugin API

Publish services, interfaces, events, and compatibility contracts.
