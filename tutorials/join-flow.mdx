---
title: "Build a join flow"
description: "Welcome players, load profiles async, and clean up sessions."
icon: "door-open"
---

# Build a join flow

Welcome players, load profiles async, and clean up sessions.
...
```mermaid
flowchart LR
  A["Build a join flow"] --> B["Build the core"]
