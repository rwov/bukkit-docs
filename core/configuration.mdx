...
Ship defaults, validate YAML, save changes, and reload atomically.
...
public final class ConfigurationFeature {
    ...
    public ConfigurationFeature(JavaPlugin plugin) {
        this.plugin = plugin;
    }

    public void enable() {
        plugin.getLogger().fine("Configuration enabled");
    }
