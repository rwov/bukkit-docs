...
Use load, enable, disable, dependency order, and deterministic cleanup.
...
```java
public final class PluginlifecycleFeature {
    private final JavaPlugin plugin;

    public PluginlifecycleFeature(JavaPlugin plugin) {
        this.plugin = plugin;
    }

    public void enable() {
        plugin.getLogger().fine("Plugin lifecycle enabled");
    }
