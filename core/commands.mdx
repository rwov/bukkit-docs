...
Build command trees, sender checks, parsing, usage, and tab completion.
...
public boolean onCommand(CommandSender sender, Command command,
    ...
    if (!player.hasPermission("example.use")) return true;
    return service.execute(player.getUniqueId(), args);
}
```
