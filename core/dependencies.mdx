...
Use depend, softdepend, loadbefore, and capability checks.
...
```java
public final class PlugindependenciesFeature {
    private final JavaPlugin plugin;

    public PlugindependenciesFeature(JavaPlugin plugin) {
        this.plugin = plugin;
    }

    public void enable() {
        plugin.getLogger().fine("Plugin dependencies enabled");
    }
