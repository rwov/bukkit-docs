...
Publish and consume plugin APIs without hard implementation coupling.
...
```java
public final class ServicesmanagerFeature {
    private final JavaPlugin plugin;

    public ServicesmanagerFeature(JavaPlugin plugin) {
        this.plugin = plugin;
    }

    public void enable() {
        plugin.getLogger().fine("Services manager enabled");
    }
