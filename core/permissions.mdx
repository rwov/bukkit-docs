...
Design nodes, children, defaults, attachments, and secure authorization.
...
public final class PermissionsFeature {
    ...
    public PermissionsFeature(JavaPlugin plugin) {
        this.plugin = plugin;
    }

    public void enable() {
        plugin.getLogger().fine("Permissions enabled");
    }
