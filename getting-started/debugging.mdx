...
Read stack traces and diagnose startup, classloading, and runtime failures.
...
```java
public final class DebuggingpluginsFeature {
    private final JavaPlugin plugin;

    public DebuggingpluginsFeature(JavaPlugin plugin) {
        this.plugin = plugin;
    }

    public void enable() {
        plugin.getLogger().fine("Debugging plugins enabled");
    }
