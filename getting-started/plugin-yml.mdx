...
Declare metadata, commands, permissions, dependencies, and compatibility.
...
```java
public final class pluginymlreferenceFeature {
    private final JavaPlugin plugin;

    public pluginymlreferenceFeature(JavaPlugin plugin) {
        this.plugin = plugin;
    }

    public void enable() {
        plugin.getLogger().fine("plugin.yml reference enabled");
    }
