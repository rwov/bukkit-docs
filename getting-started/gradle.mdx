...
Use Kotlin DSL, compileOnly dependencies, toolchains, and resource processing.
...
```java
public final class GradlesetupFeature {
    private final JavaPlugin plugin;

    public GradlesetupFeature(JavaPlugin plugin) {
        this.plugin = plugin;
    }

    public void enable() {
        plugin.getLogger().fine("Gradle setup enabled");
    }
