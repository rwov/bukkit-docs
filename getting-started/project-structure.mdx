...
Organize plugins by feature, layer, module, and lifecycle owner.
...
```java
public final class ProjectstructureFeature {
    private final JavaPlugin plugin;

    public ProjectstructureFeature(JavaPlugin plugin) {
        this.plugin = plugin;
    }

    public void enable() {
        plugin.getLogger().fine("Project structure enabled");
    }
