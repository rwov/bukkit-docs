...
Create, compile, install, and verify a complete JavaPlugin.
...
```java
public final class YourfirstpluginFeature {
    private final JavaPlugin plugin;

    public YourfirstpluginFeature(JavaPlugin plugin) {
        this.plugin = plugin;
    }

    public void enable() {
        plugin.getLogger().fine("Your first plugin enabled");
    }
