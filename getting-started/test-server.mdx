...
Build a safe development server and shorten the edit-test cycle.
...
```java
public final class LocaltestserverFeature {
    private final JavaPlugin plugin;

    public LocaltestserverFeature(JavaPlugin plugin) {
        this.plugin = plugin;
    }

    public void enable() {
        plugin.getLogger().fine("Local test server enabled");
    }
