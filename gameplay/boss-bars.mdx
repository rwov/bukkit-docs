...
Display shared progress, timers, phases, flags, and player membership.
...
```java
public final class BossbarsFeature {
    private final JavaPlugin plugin;

    public BossbarsFeature(JavaPlugin plugin) {
        this.plugin = plugin;
    }

    public void enable() {
        plugin.getLogger().fine("Boss bars enabled");
    }
