...
Build efficient scoped audiovisual feedback.
...
```java
public final class SoundsandparticlesFeature {
    private final JavaPlugin plugin;

    public SoundsandparticlesFeature(JavaPlugin plugin) {
        this.plugin = plugin;
    }

    public void enable() {
        plugin.getLogger().fine("Sounds and particles enabled");
    }
