...
Use modern typed properties, parsing, rotation, mirroring, and matching.
...
```java
public final class BlockDataFeature {
    private final JavaPlugin plugin;

    public BlockDataFeature(JavaPlugin plugin) {
        this.plugin = plugin;
    }

    public void enable() {
        plugin.getLogger().fine("BlockData enabled");
    }
