...
Spawn, query, customize, track, move, and remove every entity family.

{/* visual-map:start */}
<Frame caption="A TextDisplay, ItemDisplay, and Interaction entity combined into one clickable hologram.">
  ![Entities and mobs example](/assets/modern/display-hologram.webp)
</Frame>
...
```java
Zombie guardian = world.spawn(location, Zombie.class, mob -> {
    mob.setCustomName("§cGuardian");
