...
Create chunk generators, biome providers, noise, and structures.
...
```java
public final class WorldgenerationFeature {
    private final JavaPlugin plugin;

    public WorldgenerationFeature(JavaPlugin plugin) {
        this.plugin = plugin;
    }

    public void enable() {
        plugin.getLogger().fine("World generation enabled");
    }
