...
Use names, lore, enchants, attributes, models, trims, food, and specialized meta.

{/* visual-map:start */}
<Frame caption="Component-driven custom items with distinct models and behaviors.">
  ![ItemMeta and components example](/assets/modern/item-components.webp)
</Frame>
...
```java
public final class ItemMetaandcomponentsFeature {
    private final JavaPlugin plugin;

    public ItemMetaandcomponentsFeature(JavaPlugin plugin) {
        this.plugin = plugin;
    }

    public void enable() {
        plugin.getLogger().fine("ItemMeta and components enabled");
    }
