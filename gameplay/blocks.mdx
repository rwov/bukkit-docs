...
Read and mutate blocks, containers, signs, spawners, and snapshots.
...
```java
public final class BlocksandBlockStateFeature {
    private final JavaPlugin plugin;

    public BlocksandBlockStateFeature(JavaPlugin plugin) {
        this.plugin = plugin;
    }

    public void enable() {
        plugin.getLogger().fine("Blocks and BlockState enabled");
    }
