---
title: "Spigot API"
description: "Complete guide to org.spigotmc."
icon: "brackets-curly"
---
...
- `Spigot-specific server`
- `player`
- `world`
- `configuration`
- `and timings extensions`
...
<Card title="Open every org.spigotmc type and member" icon="arrow-up-right-from-square" href="https://hub.spigotmc.org/javadocs/bukkit/org/spigotmc/package-summary.html">
