---
title: "Consumables"
description: "Complete guide to org.bukkit.inventory.meta.components.consumable."
icon: "brackets-curly"
---

# Consumables

`org.bukkit.inventory.meta.components.consumable`

This package is part of the public Bukkit/Spigot plugin API.

## Important types

- `ConsumableComponent and consume settings`
...
<Card title="Open every org.bukkit.inventory.meta.components.consumable type and member" icon="arrow-up-right-from-square" href="https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/inventory/meta/components/consumable/package-summary.html">
