...
description: "Complete guide to org.bukkit.plugin.messaging."
icon: "brackets-curly"
---
...
<Card title="Open every org.bukkit.plugin.messaging type and member" icon="arrow-up-right-from-square" href="https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/plugin/messaging/package-summary.html">
