...
description: "Complete guide to org.bukkit.inventory.meta.components.consumable.effects."
icon: "brackets-curly"
---

# Consumable effects

`org.bukkit.inventory.meta.components.consumable.effects`
...
<Card title="Open every org.bukkit.inventory.meta.components.consumable.effects type and member" icon="arrow-up-right-from-square" href="https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/inventory/meta/components/consumable/effects/package-summary.html">
