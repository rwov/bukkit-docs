...
description: "Complete guide to org.bukkit.event.weather."
icon: "brackets-curly"
---
...
```mermaid
flowchart LR
  A["Server action"] --> B["Weather events"]
...
<Card title="Open every org.bukkit.event.weather type and member" icon="arrow-up-right-from-square" href="https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/event/weather/package-summary.html">
