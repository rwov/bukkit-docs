---
title: "Server events"
description: "Complete guide to org.bukkit.event.server."
icon: "brackets-curly"
---
...
```mermaid
flowchart LR
  A["Server action"] --> B["Server events"]
...
<Card title="Open every org.bukkit.event.server type and member" icon="arrow-up-right-from-square" href="https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/event/server/package-summary.html">
