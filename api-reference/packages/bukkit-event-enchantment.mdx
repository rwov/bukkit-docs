...
description: "Complete guide to org.bukkit.event.enchantment."
icon: "brackets-curly"
---
...
```mermaid
flowchart LR
  A["Server action"] --> B["Enchantment events"]
...
<Card title="Open every org.bukkit.event.enchantment type and member" icon="arrow-up-right-from-square" href="https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/event/enchantment/package-summary.html">
