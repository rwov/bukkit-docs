...
description: "Complete guide to org.bukkit.command.defaults."
icon: "brackets-curly"
---
...
<Card title="Open every org.bukkit.command.defaults type and member" icon="arrow-up-right-from-square" href="https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/command/defaults/package-summary.html">
