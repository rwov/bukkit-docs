---
title: "Player events"
description: "Complete guide to org.bukkit.event.player."
icon: "brackets-curly"
---
...
```mermaid
flowchart LR
  A["Server action"] --> B["Player events"]
...
<Card title="Open every org.bukkit.event.player type and member" icon="arrow-up-right-from-square" href="https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/event/player/package-summary.html">
