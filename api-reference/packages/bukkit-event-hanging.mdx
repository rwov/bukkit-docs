...
description: "Complete guide to org.bukkit.event.hanging."
icon: "brackets-curly"
---
...
```mermaid
flowchart LR
  A["Server action"] --> B["Hanging events"]
...
<Card title="Open every org.bukkit.event.hanging type and member" icon="arrow-up-right-from-square" href="https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/event/hanging/package-summary.html">
