---
title: "Entity events"
description: "Complete guide to org.bukkit.event.entity."
icon: "brackets-curly"
---
...
```mermaid
flowchart LR
  A["Server action"] --> B["Entity events"]
...
<Card title="Open every org.bukkit.event.entity type and member" icon="arrow-up-right-from-square" href="https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/event/entity/package-summary.html">
