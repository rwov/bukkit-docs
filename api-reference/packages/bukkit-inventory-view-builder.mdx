---
title: "View builders"
description: "Complete guide to org.bukkit.inventory.view.builder."
icon: "brackets-curly"
---
...
- `InventoryViewBuilder and typed builders`
...
<Card title="Open every org.bukkit.inventory.view.builder type and member" icon="arrow-up-right-from-square" href="https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/inventory/view/builder/package-summary.html">
