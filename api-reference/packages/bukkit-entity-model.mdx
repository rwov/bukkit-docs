---
title: "Entity models"
description: "Complete guide to org.bukkit.entity.model."
icon: "brackets-curly"
---

# Entity models

`org.bukkit.entity.model`
...
- `PlayerModelPart and entity model contracts`
...
<Card title="Open every org.bukkit.entity.model type and member" icon="arrow-up-right-from-square" href="https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/entity/model/package-summary.html">
