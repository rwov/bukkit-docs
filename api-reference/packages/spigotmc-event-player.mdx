---
title: "Spigot player events"
description: "Complete guide to org.spigotmc.event.player."
icon: "brackets-curly"
---
...
```mermaid
flowchart LR
  A["Server action"] --> B["Spigot player events"]
...
- `PlayerSpawnLocationEvent and Spigot-specific player events`
...
<Card title="Open every org.spigotmc.event.player type and member" icon="arrow-up-right-from-square" href="https://hub.spigotmc.org/javadocs/bukkit/org/spigotmc/event/player/package-summary.html">
