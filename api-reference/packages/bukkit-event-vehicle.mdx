...
description: "Complete guide to org.bukkit.event.vehicle."
icon: "brackets-curly"
---
...
```mermaid
flowchart LR
  A["Server action"] --> B["Vehicle events"]
...
<Card title="Open every org.bukkit.event.vehicle type and member" icon="arrow-up-right-from-square" href="https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/event/vehicle/package-summary.html">
