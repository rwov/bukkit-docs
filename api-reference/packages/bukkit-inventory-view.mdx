...
description: "Complete guide to org.bukkit.inventory.view."
icon: "brackets-curly"
---
...
- `InventoryView and specialized views`
...
<Card title="Open every org.bukkit.inventory.view type and member" icon="arrow-up-right-from-square" href="https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/inventory/view/package-summary.html">
