---
title: "World events"
description: "Complete guide to org.bukkit.event.world."
icon: "brackets-curly"
---
...
```mermaid
flowchart LR
  A["Server action"] --> B["World events"]
...
<Card title="Open every org.bukkit.event.world type and member" icon="arrow-up-right-from-square" href="https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/event/world/package-summary.html">
